...
for k in range(len(common_ids))[1000:2000]:
    ...
    features_gene.columns=['feature',gene_id] 
...
## save data frames
df_features.T.to_csv('./processed/features_genes1000.csv',sep=' ',header=True)
df_sequences.T.to_csv('./processed/sequences_genes1000.csv',sep=' ',header=True) 
