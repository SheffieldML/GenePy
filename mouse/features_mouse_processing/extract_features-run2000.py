...
for k in range(len(common_ids))[2000:3000]:
...
## save data frames
df_features.T.to_csv('./processed/features_genes2000.csv',sep=' ',header=True)
df_sequences.T.to_csv('./processed/sequences_genes2000.csv',sep=' ',header=True) 
