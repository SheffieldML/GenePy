...
for k in range(len(common_ids)):
    ...
    sequence_3utr = replace_ns(seqs_3utr.ix[indx_3utr,'gene_sequence'].lower()) 
    sequence_5utr = replace_ns(seqs_5utr.ix[indx_5utr,'gene_sequence'].lower())
    sequence_tregion = replace_ns(seqs_tregion.ix[indx_tregion,'gene_sequence'].lower()) 
